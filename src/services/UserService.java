...
public class UserService {
   ...
   //var
    ...
    public void signup(TextField username,TextField userprenom,TextField numteluser,TextField adresseuser, ComboBox<String> roles ,TextField emailuser,TextField mdpuser,TextField ageuser, Resources res ) {
        ...
        String url = Statics.Url_Signin+"/registerjson/new?nom="+username.getText().toString()+"&prenom="+userprenom.getText().toString()+
   ...
   public boolean signin(String username, String password) {
    String url = Statics.Url_Signin + "/loginjson?email=" + username + "&mdp=" + password;
...
//    }
  public void SendReset(User c) {
     ...
     public boolean addTask(User t) {
        ...
        //1
        String addURL = Statics.Url_Signin + "/registerjson/new";
        ...
        int age = (int) (t.getAge());
           req.addArgument("age", String.valueOf(age));
        ...
        String url  = Statics.Url_Signin+"/editjson/"+SessionManager.getId()+"?nom="+ nomuser.getText().toString() +"&prenom="+ prenom.getText().toString()+"&mdp="+password.getText().toString();
  req.setUrl(url);
